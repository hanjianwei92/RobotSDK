...
def test(test_count):
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            #
            # # 设置碰撞等级
            ret = robot.set_collision_class(7)
            logger.info(f"set collision ret is {ret}")
...
def move_rotate_test():
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            rotate_axis = list(map(lambda a, b: a - b, tool_pos_on_base['pos'], current_pos['pos']))
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            while True:
                ...
                joint_radian = (
                    55.5 / 180.0 * pi, -20.5 / 180.0 * pi, -72.5 / 180.0 * pi, 38.5 / 180.0 * pi, -90.5 / 180.0 * pi,
                    55.5 / 180.0 * pi)
                robot.move_joint(joint_radian, True)
