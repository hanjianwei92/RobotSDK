...
class GripperCommand:
    ...
    def gripper_go(self, position: float, effort: float):
        gripper_command_goal = self.__init_gripper_command_goal(position, effort)
        self.__send_goal_async_gripper_command(gripper_command_goal)
    ...
    def get_gripper_joint_position(self):
        ...
        return [ joint_state.position[joint_state.name.index(joint_name)] for joint_name in self.__joint_names]
